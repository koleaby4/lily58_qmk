...
[_L1] = LAYOUT( \
  ...
  _______,    _______, _______, _______, _______, _______,                     KC_PGUP, KC_HOME, KC_UP  , KC_END,  KC_INS , KC_GRV,  \
  _______,    _______, _______, _______, _______, _______,  KC_MINS, KC_EQL,   KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_NUBS, _______, \
