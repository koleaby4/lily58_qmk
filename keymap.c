...
[_L1] = LAYOUT( \
  ...
  _______,    KC_LBRC, S(KC_LBRC), 	S(KC_RBRC), KC_RBRC,  	KC_EQL,            	  			KC_PGUP, KC_HOME, KC_UP  , KC_END,  KC_MINS, KC_GRV,  \
  _______,    _______, _______, 	_______, 	_______, 	_______,  	KC_MINS,  KC_INS,   KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_NUBS, _______, \
...
[_L2] = LAYOUT( \
  ...
  _______, _______, _______, _______, _______, _______, DM_REC1, DM_PLY1, _______, _______, _______, _______, _______, _______,\
                             _______, _______, _______, _______, _______,  _______, _______, _______ \
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
